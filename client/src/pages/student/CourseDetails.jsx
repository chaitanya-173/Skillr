    ...
    <>
      <div className='flex md:flex-rowflex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
        ...
        <div className='max-w-xl z-10 text-gray-500'>
          ...
          <h1 className='md:text-course-details-heading-large text-3xl font-semibold text-gray-800'>{courseData.courseTitle}</h1>
        ...
        <div>
          ...
          <div className='max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
            ...
            <p className='md:text-3xl text-gray-500'>{courseData.coursePrice} Rs.</p>
          </div>

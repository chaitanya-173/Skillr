    ...
    <div className='h-screen overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <form className='flex flex-col gap-4 max-w-md w-full text-gray-500' onSubmit={handleSubmit} >
        ...
        <div className='flex flex-col gap-1'>
          <p>Course Title</p>
          <input onChange={e => setCourseTitle(e.target.value)} required value={courseTitle} type="text" placeholder='Type here'
        ...
        <div className='flex items-center justify-between flex-wrap' >
          <div className='flex flex-col gap-1'>
            <p>Course Price</p>
            <input onChange={e => setCoursePrice(e.target.value)} value={coursePrice} type="number" placeholder='0' required
            ...
            <div key={chapterIndex} className="bg-white border rounded-lg mb-4">
              <div className="flex justify-between items-center p-4 border-b">
                <div className='flex items-center'>
                  <img onClick={() => handleChapter('toggle', chapter.chapterId)} src={assets.dropdown_icon} width={14} alt="" className={`mr-2 cursor-pointer transition-all ${chapter.collapsed === true ? "-rotate-90" : ""}`} />
            ...
            showPopup && (
              <div className="fixed inset-0 flex items-center justify-center bg-gray-800/30 backdrop-blur-sm z-50">
                <div className='bg-white text-gray-700 p-4 rounded relative w-full max-w-80'>
                  ...
                  <h2 className="text-1g font-semibold mb-4">Add Lecture</h2>
                  ...
                  <div className="mb-2">
                    ...
                    <input type="text"value={lectureDetails.lectureDuration}
                      className="mt-1 block w-full border rounded py-1 px-2"
                  ...
                  <div className="flex gap-2 my-4">
                    <p>Is Preview Free?</p>
                    <input type='checkbox' value={lectureDetails.isPreviewFree}
